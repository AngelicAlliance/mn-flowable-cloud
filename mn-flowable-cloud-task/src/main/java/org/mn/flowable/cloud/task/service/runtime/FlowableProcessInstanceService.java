 ...
 */
package org.mn.flowable.cloud.task.service.runtime;
...
import org.mn.flowable.cloud.common.service.exception.NotPermittedException;
import org.mn.flowable.cloud.task.model.runtime.CreateProcessInstanceRepresentation;
import org.mn.flowable.cloud.task.model.runtime.ProcessInstanceRepresentation;
import org.mn.flowable.cloud.task.service.api.UserCache;
...
public class FlowableProcessInstanceService {
    ...
    public ProcessInstanceRepresentation startNewProcessInstance(CreateProcessInstanceRepresentation startRequest) {
        ...
        User user = null;
        if (processInstance.getStartUserId() != null) {
            UserCache.CachedUser cachedUser = userCache.getUser(processInstance.getStartUserId());
